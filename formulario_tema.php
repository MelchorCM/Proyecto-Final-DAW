      ...
      <div class="row align-items-stretch no-gutters contact-wrap">
        <div class="col-md-6">
          <div class="form h-100">
            ...
            <form action="crear_tema.php" class="mb-5" method="post" id="contactForm" name="contactForm" ENCTYPE="multipart/form-data">
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12 form-group mb-5">
                  ...
                  <textarea class="form-control" name="descripcion" id="descripcion" cols="30" rows="4"  placeholder="Describe tu consulta"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group mb-5">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <input type="submit" value="Enviar consulta" NAME="insertar" class="boton_form btn btn-primary rounded-0 py-2 px-4">
...
.boton_form, .form-control, .custom-select {
  height: 45px; }
...
#form-descripcion-warning, #form-descripcion-success {
  display: none; }
